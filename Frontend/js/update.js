...
function getWeather(data) {
    ...
    let paren = document.querySelector('#parent');
        ...
        <p>Колір: <span>${data[localStorage.test].color}</span>;</p>
        <p>Ціна: <span>${data[localStorage.test].rate}</span>;</p>  
...
function createCars(data) {
  ...
  const createURL = `http://localhost:8080/cars/${localStorage.idcar}/update`
